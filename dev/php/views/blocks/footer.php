<!--FOOTER-->
<a href="<?php echo $jsonLangGlobals->order_online_shop_link->texte; ?>" class="order_footer_btn_visual" target="_blank"><img src="assets/imgs/ui/machine.png" /></a>
<a href="<?php echo $jsonLangGlobals->order_online_shop_link->texte; ?>" class="order_footer_btn"  target="_blank"><span><?php echo $jsonLangGlobals->order->texte; ?></span></a>
<footer>
