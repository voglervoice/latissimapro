<section id="milksystem">
	...
	<div class="milk_content">
		...
		<span class="milk_description milk_description_n"><?php echo proccedText($jsonLangMilk->text_paragraph_1_milk_frothtext_paragraph_1_milk_froth->texte); ?></span>
		<div class="visual_fig_ct">
			<div class="visual_fig">
				<div class="visual_pot"></div>
				<span class="milk_figdescription"><?php echo $jsonLangMilk->schema_milk_froth_text_->texte; ?></span>
			</div>
